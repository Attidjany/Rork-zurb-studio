-- Remove automatic triggers and make auto-scenario generation manual
-- This fixes duplicate key errors and gives user control

-- Drop all existing auto-scenario triggers
...
-- Drop the automatic check function (we'll keep generate_auto_scenarios for manual use)
DROP FUNCTION IF EXISTS check_and_generate_auto_scenarios CASCADE;

-- Improve the generate_auto_scenarios function to handle duplicates better
-- and use transaction-level locking
...
BEGIN
  ...
  -- Delete existing auto-scenarios for this site and their related data
  -- CASCADE will handle scenario_construction_costs, scenario_housing_types, etc.
